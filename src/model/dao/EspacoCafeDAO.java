...
public class EspacoCafeDAO extends BaseDAO<Espaco> {
    ...
    public List<Espaco> getList() {
        ...
        return this.entityManager.createNamedQuery("espaco.findByTipo").setParameter("tipo_espaco", tipoEspacoDAO.getById(2)).getResultList();
    }
}
